...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef* hcan)
{
	...
	if (hcan == &hcan1)		
	{
		...
		switch (can_rx.StdId)
		{
			case RUI_DF_MOTOR_HEAD_3508_5_ID:
				RUI_F_MOTOR_CAN_RX_3508RM(&RUI_V_MOTOR_SWAY,rx_data);
 				break;
            case RUI_DF_MOTOR_HEAD_2006_L_ID:
				RUI_F_MOTOR_CAN_RX_2006RM(&RUI_V_MOTOR_Left,rx_data);
				break;

            case RUI_DF_MOTOR_HEAD_2006_R_ID:
				RUI_F_MOTOR_CAN_RX_2006RM(&RUI_V_MOTOR_Right,rx_data);
				break;

            case RUI_DF_MOTOR_HEAD_6020_YAW_ID:
				WHW_F_MOTOR_CAN_RX_6020RM(&RUI_V_MOTOR_Yaw,rx_data);
				break;
			case RUI_DF_MOTOR_HEAD_2006_Camera_ID:
				RUI_F_MOTOR_CAN_RX_2006RM(&RUI_V_MOTOR_Camera,rx_data);
				break;
	...
	if (hcan == &hcan2)		
	{
		...
		switch (can_rx.StdId)
		{
			case RUI_DF_MOTOR_HEAD_3508_1_ID:
				RUI_F_MOTOR_CAN_RX_3508RM(&RUI_V_MOTOR_HORIZONTAL_L,rx_data);
				break;
			
			case RUI_DF_MOTOR_HEAD_3508_2_ID:
				RUI_F_MOTOR_CAN_RX_3508RM(&RUI_V_MOTOR_HORIZONTAL_R,rx_data);
				break;
			
			case RUI_DF_MOTOR_HEAD_3508_3_ID:
				RUI_F_MOTOR_CAN_RX_3508RM(&RUI_V_MOTOR_LIFT_L,rx_data);
				break;
			
			case RUI_DF_MOTOR_HEAD_3508_4_ID:
				RUI_F_MOTOR_CAN_RX_3508RM(&RUI_V_MOTOR_LIFT_R,rx_data);
				break;
