 ...
 * @LastEditors: Andy
 * @LastEditTime: 2024-05-04 14:54:34
 */
...
void RUI_F_ANONYMITY_TX(int16_t NUM1 , int16_t NUM2 , int16_t NUM3 , int16_t NUM4 , int16_t NUM5 , int16_t NUM6 , int16_t NUM7 , int16_t NUM8 , int16_t NUM9)
{
    ...
    HAL_UART_Transmit_DMA(&huart1 , RUI_V_ANONYMITY_UNION.DATA , 24);
...
void RUI_F_AN_REVOLVE(void)
{
    RUI_F_ANONYMITY_TX((int16_t) 0 ,
                       (int16_t) MYADC.ADC_name.URy , 
                       (int16_t) MYADC.ADC_name.URz ,  
                       (int16_t) 0 ,		 
                       (int16_t) 0 ,			
                       (int16_t) 0 , 
					   (int16_t) Transmit_Data.channels.URy ,  
					   (int16_t) Transmit_Data.channels.URz ,	  
                       (int16_t) 0		  
    );
